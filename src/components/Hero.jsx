...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="bg-s1 position-relative overflow-hidden"
    ...
    >
      ...
      <div
        style={{
          ...
          pointerEvents: "none",
          backgroundImage:
            "linear-gradient(rgba(124,92,252,0.045) 1px,transparent 1px),linear-gradient(90deg,rgba(124,92,252,0.045) 1px,transparent 1px)",
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle,rgba(124,92,252,0.13),transparent 70%)",
          pointerEvents: "none",
        }}
      />
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle,rgba(0,212,170,0.09),transparent 70%)",
          pointerEvents: "none",
        }}
      />
      <canvas
      ...
      <div className="container position-relative" style={{ zIndex: 1 }}>
        <div className="row align-items-center" style={{ minHeight: "100vh" }}>
          <div className="col-lg-7 py-5">
            ...
            >
              Recent CS graduate passionate about building robust full-stack web
              applications. Specializing in Java, Spring Boot, and React.
            </p>
            ...
            <div className="d-flex flex-wrap gap-3">
              <a
                href="#projects"
                className="btn btn-accent px-4 py-2 rounded-3"
              >
                View Projects ↓
              </a>
              <a
                href="#contact"
                className="btn btn-ghost-accent px-4 py-2 rounded-3"
              >
                Let's Connect →
              </a>
              <a
                href="/UpdatedResume-Rajesh.pdf"
